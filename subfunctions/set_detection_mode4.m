...
%% setting up the figure, panels and buttons
    ...
    hfname_str = uipanel('Units','characters',...
        'Parent',fh,...
        'Title','Spot Image filters - Optional, batch mode only',...
        'Position',[12.5,16,55,10]);
    
        uicontrol('Parent',hfname_str,'Units','characters',...
            'Style','Text',...
            'String','Spot Image Name Contains :',...
    ...
    % adaptive mode (i.e. use ROIs to set threshold locally)    
    uicontrol('Parent',fh,'Style','Radio','Units','characters',...
            'String','Adaptive Threshold Using Masks',...
            'Tag','adaptive',...
            'Position',[14.5,14.5,25,1.2]);
    
    % Strings that file name must or must not contain for the batch mode:
    hfname_str = uipanel('Units','characters',...
        'Parent',fh,...
        'Title','Masks Filters - Optional, adaptive batch mode only',...
...
%% nested callback function
    function get_mode(src,eventdata,fh,hsel_mode)
        ...
        if contains(params.fileProcessingMode,'batch') && params.adaptive
